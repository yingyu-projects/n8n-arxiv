"""Workflow repository implementation for SQLite."""
...
class WorkflowRepositorySQLite(WorkflowRepository):
    """SQLite-specific implementation of WorkflowRepository."""
    ...
    async def save(self, workflow: Workflow) -> Workflow:
        ...
        if existing:
            ...
            orm = WorkflowMapper.to_orm(workflow, convert_uuid_to_string=True)
